...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "CONVERTIDORPESOVOLUMENTEMPERATURA.Android.dll" comes first in this list. */
		"CONVERTIDORPESOVOLUMENTEMPERATURA.Android.dll",
		"CONVERTIDORPESOVOLUMENTEMPERATURA.dll",
		"FormsViewGroup.dll",
